...
{
    /// <summary>ss252 Area Work(E#213)</summary>
    public class ss252AreaWork : OracleEntity 
    {
        ...
        #region Indexes
        /// <summary>ss252_Area_Work_X1</summary>
        public readonly Index SortByss252_Area_Work_X1 = new Index
        {
        	Caption = "ss252_Area_Work_X1",
        	Name = "ss252_Area_Work_X1",
        	AutoCreate = true,
        	Unique = true
        };
        #endregion
        
        public ss252AreaWork():base("ss252_Area_Work", "ss252 Area Work", DataSources.SS)
        {
        ...
        {
            SortByss252_Area_Work_X1.Add(AreaCode, ReportGroup, ReportDepartment, ReportSubDepartment);
