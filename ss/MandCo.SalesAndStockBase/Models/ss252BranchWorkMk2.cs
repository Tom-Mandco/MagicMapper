...
{
    /// <summary>ss252 Branch Work Mk2(E#244)</summary>
    public class ss252BranchWorkMk2 : OracleEntity 
    {
        ...
        public readonly NumberColumn TYSeason = new NumberColumn("TY_Season", "N8A", "TY Season");
        ...
        /// <summary>Budget Season</summary>
        public readonly NumberColumn BudgetSeason = new NumberColumn("Budget_Season", "N8A", "Budget Season");
        ...
        public readonly NumberColumn LYSeason = new NumberColumn("LY_Season", "N8A", "LY Season");
        ...
        #region Indexes
        /// <summary>ss252_Branch_Mk2_X1</summary>
        public readonly Index SortByss252_Branch_Mk2_X1 = new Index
        {
        	Caption = "ss252_Branch_Mk2_X1",
        	Name = "ss252_Branch_Mk2_X1",
        	AutoCreate = true,
        	Unique = true
        };
        #endregion
        
        public ss252BranchWorkMk2():base("ss252_Branch_Mk2", "ss252 Branch Work Mk2", DataSources.SS)
        {
        ...
        {
            SortByss252_Branch_Mk2_X1.Add(AreaCode, BranchNumber, ReportGroup, FloorCode, ReportDepartment, ReportSubDepartment);
